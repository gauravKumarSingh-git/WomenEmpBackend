...
public class FeedbackServiceImpl implements FeedbackService{
		...
		@Override
		public FeedbackDTO viewFeedbackByUserId(Integer userId) throws WomenEmpException {
			Feedback fromRepo = feedbackRepository.viewFeedbackByUserId(userId);
			if (fromRepo == null)
				throw new WomenEmpException("Service.FEEDBACK_NOT_PRESENT");

			FeedbackDTO feedbackDTO = FeedbackDTO.entityToDTO(fromRepo);
			return feedbackDTO;
		}
