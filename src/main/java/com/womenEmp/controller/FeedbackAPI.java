...
public class FeedbackAPI {
	...
	public ResponseEntity<FeedbackDTO> viewFeedbackByUserId(@PathVariable Integer userId) throws WomenEmpException{
		FeedbackDTO ret = feedbackService.viewFeedbackByUserId(userId);
		return new ResponseEntity<>(ret, HttpStatus.OK);
	}
}