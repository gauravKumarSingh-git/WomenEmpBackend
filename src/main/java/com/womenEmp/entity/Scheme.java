...
public class Scheme {
	...
	public static Scheme dtoToEntity(SchemeDTO schemesDto) {
		...
		TrainingCourseDTO trainingCourse = schemesDto.getTrainingCourse();
		if(trainingCourse == null) {
			schemes.setTrainingCourse(null);
		}else {
			schemes.setTrainingCourse(TrainingCourse.dtotoEntity(trainingCourse));
		}
		return schemes;
