...
public static SchemeDTO entityToDTO(Scheme schemes) {
		...
		TrainingCourse trainingCourse = schemes.getTrainingCourse();
		if(trainingCourse == null) {
			schemesDTO.setTrainingCourse(null);
		}else {
			schemesDTO.setTrainingCourse(TrainingCourseDTO.entityToDTO(trainingCourse));
		}
